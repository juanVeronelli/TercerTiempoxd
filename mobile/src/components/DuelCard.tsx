...
import { formatUserFacingError } from "../api/apiErrors";
...
export const DuelCard = ({
  ...
  const handleGenerateDuel = async () => {
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(error, "Error al generar el duelo."),
        undefined,
        "error",
      );
    } finally {
        ...
        {isAdmin ? (
          <View style={styles.emptyContent}>
            <Text style={styles.emptyText}>
              Aún no se ha definido el enfrentamiento estelar. Podés generarlo
              manualmente o se creará solo cuando todos los convocados confirmen
              asistencia.
            </Text>
            <TouchableOpacity
          ...
          <View style={styles.mysteryContent}>
            ...
            <Text style={styles.emptyText}>
              El duelo de la fecha se asigna cuando todos los convocados confirman
              que van a jugar (o lo genera un administrador de la liga).
            </Text>
          </View>
        )}
      </View>
