...
export default function PaywallScreen() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      if (e && typeof e === "object" && (e as { userCancelled?: boolean }).userCancelled) return;
      showAlert(
        "Error",
        formatUserFacingError(e, "No se pudo completar la compra."),
        undefined,
        "error",
      );
    } finally {
  ...
  const handleRestore = async () => {
    ...
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(e, "No se pudieron restaurar las compras."),
        undefined,
        "error",
      );
    } finally {
