...
export default function HonorsRankingScreen() {
  ...
  const fetchHonors = async () => {
    ...
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(error, "No se pudo cargar el Salón de la Fama."),
        undefined,
        "error",
      );
    } finally {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
          ...
          <View style={styles.tableLabels}>
            ...
            <TouchableOpacity
              style={styles.colHonorHeader}
              onPress={() => handleSort("mvp_count")}
            >
              <MaterialCommunityIcons name="trophy" size={16} color="#F59E0B" />
              <SortIcon field="mvp_count" />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.colHonorHeader}
              onPress={() => handleSort("fantasma_count")}
            >
              <MaterialCommunityIcons name="ghost" size={16} color="#A78BFA" />
              <SortIcon field="fantasma_count" />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.colHonorHeader}
              onPress={() => handleSort("worst_player_count")}
            >
              <MaterialCommunityIcons name="tree" size={16} color="#EF4444" />
              <SortIcon field="worst_player_count" />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.colHonorHeader}
              onPress={() => handleSort("duel_count")}
            >
              <MaterialCommunityIcons
                ...
                color="#10B981"
              />
              <SortIcon field="duel_count" />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.colHonorHeader}
              onPress={() => handleSort("prediction_count")}
            >
              <MaterialCommunityIcons
                name="crystal-ball"
                size={16}
                color="#22D3EE"
              />
              <SortIcon field="prediction_count" />
            </TouchableOpacity>
          </View>
