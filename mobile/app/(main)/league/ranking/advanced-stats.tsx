...
export default function AdvancedStatsScreen() {
  ...
  const fetchAdvancedStats = async () => {
    ...
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(error, "No se pudieron cargar las estadísticas avanzadas."),
        undefined,
        "error",
      );
    } finally {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <IconButton onPress={() => router.back()} accessibilityLabel="Volver" style={styles.backBtn}>
