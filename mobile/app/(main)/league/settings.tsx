...
export default function LeagueSettingsScreen() {
  ...
  const loadData = async () => {
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(error, "No se pudieron cargar los datos."),
        undefined,
        "error",
      );
    } finally {
        ...
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              showAlert(
                "Error",
                formatUserFacingError(error, "No se pudo abandonar la liga. Intentá de nuevo."),
                undefined,
                "error",
              );
            } finally {
  ...
  const handleDeleteLeague = () => {
    ...
    showAlert(
      "Eliminar liga",
      "Esta acción es permanente. Se eliminarán partidos, ranking y datos asociados de la liga. ¿Deseas continuar?",
      [
        { text: "Cancelar", style: "cancel" },
        {
          text: "Eliminar",
          ...
          onPress: async () => {
            ...
            try {
              ...
              showAlert("Liga eliminada", "La liga se eliminó correctamente.", [
                { text: "OK", onPress: () => router.replace("/(main)") },
              ]);
            } catch (error: unknown) {
              showAlert(
                "No se pudo eliminar",
                formatUserFacingError(error, "Reintentá en unos segundos."),
                undefined,
                "error",
              );
            } finally {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      showAlert(
        "Error",
        formatUserFacingError(error, "No se pudo actualizar la liga."),
        undefined,
        "error",
      );
    } finally {
      ...
      { text: "Cancelar", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            ...
            showAlert(
              "Error",
              formatUserFacingError(e, "Error al cambiar rol."),
              undefined,
              "error",
            );
          }
      ...
      { text: "Cancelar", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            ...
            showAlert(
              "Error",
              formatUserFacingError(e, "No se pudo expulsar."),
              undefined,
              "error",
            );
          }
  ...
  const handlePickLeaguePhoto = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok && data.league?.profile_photo_url) {
        ...
        showAlert(
          "Error",
          rawErr || "No se pudo subir la foto.",
          undefined,
          "error",
        );
      }
      ...
      showAlert(
        "Error",
        formatUserFacingError(e, "No se pudo subir la foto. Revisá tu conexión."),
        undefined,
        "error",
      );
    } finally {
