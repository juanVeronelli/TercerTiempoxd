...
export const createMatchSchema = z.object({
  ...
  maxPlayers: z
    .coerce
    .number()
    .int("maxPlayers debe ser un entero")
    .min(2, "El mínimo de jugadores es 2")
    .optional(),
  matchMode: z.enum(["INTERNAL", "EXTERNAL"] as const).optional(),
...
export const updateMatchStatusSchema = z.object({
  ...
  // Opcional: cuando el admin pasa a VOTACIÓN o CIERRE, puede enviar el resultado.
  // La obligatoriedad se valida en el controlador (según status y/o datos existentes del partido).
  teamAScore: z
    .coerce
    .number()
