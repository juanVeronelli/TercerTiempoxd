...
import {
  ...
  unconfirmMatch,
  adminConfirmPlayer,
  adminConfirmAllPending,
  adminRemoveSpectator,
  signupMatch,
  unsignupMatch,
  spectateMatch,
  unspectateMatch,
...
router.post("/:matchId/unspectate", authenticateToken, unspectateMatch);
router.get("/:leagueId/voting", authenticateToken, getPendingVotes);
router.get("/:matchId/details", authenticateToken, getMatchDetails);
router.post("/:matchId/comments/:voteId/react", authenticateToken, reactToMatchComment);
router.post("/:matchId/comments/:voteId/reply", authenticateToken, replyToMatchComment);
router.put(
  "/:matchId/status",
  authenticateToken,
...
router.post("/:matchId/claim-ttp", authenticateToken, claimMatchTtp);
